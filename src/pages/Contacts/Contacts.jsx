            ...
            <div className="wrapper">
                <div className="contacts__block">
                    ...
                    <div className="contacts__content-block">
                            ...
                            <div className="contacts__office">
                                ...
                                <div>
                                    <svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path id="Shape" fillRule="evenodd" clipRule="evenodd" d="M0 7C0 12.2 7 20 7 20C7 20 14 12.2 14 7C14 3.1 10.9 0 7 0C3.1 0 0 3.1 0 7ZM4.5 7C4.5 5.6 5.6 4.5 7 4.5C8.4 4.5 9.5 5.6 9.5 7C9.5 8.4 8.4 9.5 7 9.5C5.6 9.5 4.5 8.4 4.5 7Z" fill="#25B2E7"></path>
                                    </svg>
                                    ул. 78 Добровольческой Бригады, д. 15, оф. 209</div>
                            </div>
                            <div className="contacts__office-contacts">
                                <h2>
                                    <a href="tel:+79233206666" itemProp="telephone">
                                ...
                                <h2>
                                    <a href="mailto:info@nextner.ru" className="contact" itemProp="email">
                        ...
                        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A9f144daf1f0f945f92a855cb2eb1a4d45d2c28e4a1af4cd135591ce3940b3856&amp;source=constructor" width="656" height="400" frameBorder="0"></iframe>                    </div>
                </div>
            </div>
            {
