...
import './Prices.css'
import { dataPrices } from './../../components/data'

export default function Prices() {
    return (
        <main className="content">
            <div className="wrapper-prices">
                <h1 className="prices-title">Цены</h1>
                            ...
                            return <div key={i} className="prices-content">
                                <div className="prices-content__main">
                                    ...
                                    <div className="prices-content__btn-block">
                                        <p className="prices-content__price">{data.price}</p>
                                        <a className="link-requisition">Оставить заявку
