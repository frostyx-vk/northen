...
export default function Header() {
    ...
    return (
        <div className='header-block'>
            <div className={'header__contacts'}>
                ...
                <div className={'header__contacts-block'}>
                    <div className={'header__contacts-tel'}>
                        <a href={contactList[0].phone}>
                            <PhoneIcon />
                            {contactList[0].phone}
                        </a>
                    </div>
                    <div className={'header__contacts-telegram'}>
                        <a href={contactList[0].telegram} className={'contact'}>
                            <TelegramIcon />
            ...
            {
                burgerIsOpen && <div className="burger-menu">
                    <div className="header__contacts-block">
                        <div className="header__contacts-tel">
                            <a href={contactList[0].phone}>
                    ...
                    <div className="burger-nav">
                        <ul className="burger__nav-list">
                            <Link to='/about' onClick={handlerMenu}>
                                О нас
                            </Link>
                            ...
                            <Link to='/contacts' onClick={handlerMenu}>
                                Контакты
                            </Link>
